...
<script type="text/javascript" src="../member/js/vconf.js"></script>
<script type="text/javascript" src="../member/js/validator.js"></script>
...
<div id="wrap">
  ...
  <div class="main">
  <form method="post" id="vForm" name="vForm" action="reg_new.php"s>
  ...
  <input type="hidden" id="r" name="reference" value="" />
	...
	<div class="main_cen">
	  ...
	  <ul class="maintable">
          ...
          <div class="inputbox"><span class="input"><cite><input id="uname" name="uname" type="text" maxlength="64" alt="用户名:无内容/有全角/排重/focusFn{nameTip}/errArea{nametip}" value="" /></cite></span></div>
          <span id="nametip"></span>
         </li>
	    <li>
		  <div class="mt_l"><span class="red">*</span>您的邮箱地址：</div>
		  <div class="mt_r">
		    <div class="inputbox"><span class="input"><cite><input id="email" name="email" type="text" maxlength="64" alt="邮箱地址:无内容/有全角/有空格/有大写/有中文/邮箱地址/非新浪邮箱/排重/focusFn{unameTip}/errArea{usernametip}" value="" /></cite></span></div>
	    ...
	    <li>
		  ...
		  <div class="mt_r">
		    <div class="inputbox"><span class="input"><cite><input id="pwd" name="pwd" type="password" alt="密码:无内容/有全角/有空格/怪字符pwd/长度{6-16}/有中文/判断强度/重复字符/连续字符/keyFn{判断强度}/focusFn{passwordTip}/errArea{passwordtip}" value="" /></cite></span></div>
	  ...
	  <ul class="maintable">
		  ...
		  <div class="mt_r">
		    <div class="inputbox"><span class="input"><cite><input id="safeanswer" name="safeanswer" type="text" maxlength="20" alt="昵称:无内容/全数字/有全角/长度{4-20}/有大写/数字字母中文/errArea{nicktip}" value=""/></cite></span></div>
