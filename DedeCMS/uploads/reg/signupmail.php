...
<div id="wrap">
  ...
  <input type="hidden" id="r" name="reference" value="" />
	...
	<div class="main_cen">
	  ...
	  <ul class="maintable">
          <li><div class="mt_l"><span class="red">*</span>您的姓名：</div>
          <div class="inputbox"><span class="input"><cite><input id="name" name="name" type="text" maxlength="64" alt="姓名:无内容/有全角/排重/focusFn{nameTip}/errArea{nametip}" value="" /></cite></span></div>
	  ...
	  <ul class="maintable">
	  	  	    <li>
		  <div class="mt_l">		  <span class="red">*</span>您的单位/学校名称：</div>
		  <div class="mt_r">
          ...
          <div class="mt_l">		  <span class="red">*</span>您的联系方式：</div>
		  <div class="mt_r">
		    <div class="inputbox">< span class="input"><cite><input id="nickName" name="nickName" type="text" maxlength="20" alt="昵称:无内容/全数字/有全角/长度{4-20}/有大写/数字字母中文/errArea{nicktip}" value=""/></cite></span></div>
			<span id="nicktip"></span>
			<div class="inputtxt zi_9">4-20位小写字母、数字或汉字（汉字算两位）组成</div>
...
-->
	  ...
	  <ul class="maintable">
	    ...
	    <li>
		  <div class="mt_l"></div>
		  <div class="mt_r">
		    <div class="inputacc"><input id="after" name="after" type="checkbox" alt="请确认您已看过并同意《UPSAPP投票使用协议》:条款/errArea{aftertip}" checked="checked" />&nbsp;我已经看过并同意《<a href="/signupagreement.html" target="_blank">UPSAPP投票使用协议</a>》</div>
